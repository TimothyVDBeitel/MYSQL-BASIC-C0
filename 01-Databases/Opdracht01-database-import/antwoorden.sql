...
127.0.0.1/mod_mysql_basic_imdb_movies/movies/		http://localhost/phpmyadmin/index.php?route=/sql&server=1&db=mod_mysql_basic_imdb_movies&table=movies&pos=0

   Weergave van records 0 - 24 (98 totaal, Query duurde 0,0004 seconden.)
